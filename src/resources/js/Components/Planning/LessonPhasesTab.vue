...
const phaseForm = ref({ title: '', duration_minutes: null, social_form: '', teacher_interaction: '', learner_activity: '', differentiation: '', didactic_comment: '', materials: '', media: '', resource_ids: [], resource_link_ids: [], material_item_ids: [] })
...
function phaseMaterialMedia(phase) {
    ...
    return [...[phase.materials, phase.media], ...files, ...links, ...items].filter(Boolean).join(' / ') || '–'
}
