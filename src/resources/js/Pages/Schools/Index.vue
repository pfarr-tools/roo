...
<template>
    <AppShell>
    <template #toolbar>
        <button class="btn btn-sm btn-primary" @click="showSchoolForm = !showSchoolForm">{{ de.addSchool }}</button>
    </template>
