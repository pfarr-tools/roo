...
const emptyContent = () => ({ prompt: '', lines: 5, lineated: false, reading_text: '', options: [newOption()], points_per_correct_answer: 1, columns: [''], rows: [{ label: '', answer: '' }], images: [{ url: '', label: '', answer: '' }], questions: [{ label: '', lines: 3 }], words: '' })
...
function save() {
    ...
    if (form.task_type !== 'checkbox') delete content.points_per_correct_answer
