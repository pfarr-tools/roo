...
<template>
    <AppShell>
        ...
        <LessonEditorModal v-if="editorOpen" :lesson="lesson" :unit="unit" :group-lessons="groupLessons" :group-id="group.id" :competency-options="competencyOptions" :competency-text="competencyText" :phase-templates="phaseTemplates" :social-forms="socialForms" :scheduled-lesson="slot.scheduled_lesson" :execution-url="`/unterricht/${slot.id}/durchfuehrung`" :show-phases="false" :show-resources="false" @close="editorOpen = false" />
    </AppShell>
</template>
