...
const props = defineProps({ group: Object, students: Array, curricula: Array, schoolPeriods: Array, ritualPhaseTemplates: Array, songVersions: { type: Array, default: () => [] }, songbookVersions: { type: Array, default: () => [] } })
