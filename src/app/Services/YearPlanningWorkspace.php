        ...
        return DB::transaction(function () use ($targetGroup, $source): TeachingUnit {
            ...
            foreach ($source->lessons as $lesson) {
                ...
                foreach ($lesson->phases as $phase) {
                    $lessonCopy->phases()->create($phase->only(['title', 'position', 'duration_minutes', 'description', 'teacher_interaction', 'learner_activity', 'differentiation', 'didactic_comment', 'materials', 'media']));
                }
            }
