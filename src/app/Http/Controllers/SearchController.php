...
class SearchController extends Controller
{
    ...
    public function __invoke(Request $request): Response|JsonResponse
    {
        ...
        $results = [
            ...
            'students' => $query ? Student::where('user_id', $userId)->where(fn ($q) => $this->matchesAny($q, ['first_name', 'last_name', 'class_name', 'denomination']))->with('school:id,name')->orderBy('last_name')->limit(10)->get(['id', 'school_id', 'first_name', 'last_name', 'class_name', 'denomination']) : collect(),
