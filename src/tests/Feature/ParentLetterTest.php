...
it('saves the introduction and downloads a parent letter', function () {
    ...
    $user = User::factory()->create(['organization_id' => $organization->id, 'name' => 'Lehrkraft Elternbrief']);
    $school = School::create(['organization_id' => $organization->id, 'name' => 'Elternbrief Schule']);
    ...
    $response->assertOk()
        ...
        ->assertHeader('content-disposition', 'attachment; filename="62.53_4b_'.now('Europe/Berlin')->format('Ymd').' Elternbrief.docx"');
