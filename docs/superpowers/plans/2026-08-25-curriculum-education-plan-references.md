# Curriculum EducationPlan References Implementation Plan
...
- [ ] **Step 2: Write the failing official-data behavior test**
...
- [ ] **Step 4: Define the reversible migration contract**
...
- Modify: `src/app/Models/TeachingUnitCompetency.php`
...
- `TeachingUnitCompetency` no longer exposes `curriculumCompetency`; its direct EducationPlan relation remains authoritative.

- [ ] **Step 1: Add failing relationship assertions**

Assert that a topic's `educationPlanReferences` relation returns the reference model and that its nested official competency returns the EducationPlan text. Assert that `TeachingUnitCompetency` has no `curriculumCompetency` relationship.

- [ ] **Step 2: Implement the slim reference model**
...
- [ ] **Step 3: Update the owning models**

Replace `competencies()` on `CurriculumTopic` with `educationPlanReferences()`, replace the reverse EducationPlan relationship, and remove the curriculum competency relationship and fillable field from `TeachingUnitCompetency`. Update the tests and all model imports.
...
- [ ] **Step 1: Add failing denomination-resolution tests**
...
- [ ] **Step 2: Add failing unresolved/ambiguous rollback tests**
...
- [ ] **Step 4: Implement binding-aware candidate selection**
...
- [ ] **Step 5: Persist only direct references**
...
- [ ] **Step 7: Commit importer behavior**
...
- [ ] **Step 1: Add failing copy/edit assertions**
...
- [ ] **Step 2: Replace controller relations and payloads**
...
- [ ] **Step 3: Update curriculum page formatting**
...
- [ ] **Step 5: Commit controller/UI migration**
...
- [ ] **Step 2: Update backend eager loads and mappings**
...
- [ ] **Step 3: Normalize overview and workspace calculations**
...
- [ ] **Step 4: Update Vue competency presentation**
...
- [ ] **Step 1: Run the focused complete curriculum import suite**
...
- [ ] **Step 2: Inspect the curriculum and EducationPlan source data**
...
- [ ] **Step 3: Add a regression fixture for every importer fix**
...
- [ ] **Step 4: Run the complete relevant suite and build**
